...
with open("good_data.csv", "w", newline='', encoding='utf-8') as csvfile:
    fieldnames = ["url", "timestamp", "email", "name", "has_ads", "detected_tags", "performance", "accessibility", "best-practices", "seo", "lcp"]
    ...
    for entry in data.values():
        writer.writerow({
            ...
            "detected_tags": ", ".join(entry.get("detected_tags") or []),
